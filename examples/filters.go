...
func main() {
	...
	groupService, err := service.NewNimbleGroupService(service.WithHost("1.1.1.1"), service.WithTenantUser("xxx"), service.WithPassword("xxx"), service.WithApiVersion("v1"), service.WithoutWaitForAsyncJobs())
	if err != nil {
