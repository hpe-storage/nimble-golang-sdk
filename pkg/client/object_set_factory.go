...
// ClientCredentialObjectSet returns a reference to the ClientCredential object set
func (client *GroupMgmtClient) GetClientCredentialObjectSet() *ClientCredentialObjectSet {
 return &ClientCredentialObjectSet{
  Client: client,
 }
}
...
func (client *GroupMgmtClient) GetActiveDirectoryMembershipObjectSet() *ActiveDirectoryMembershipObjectSet {
 return &ActiveDirectoryMembershipObjectSet{
  Client: client,
 }
}
