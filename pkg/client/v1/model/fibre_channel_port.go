...
type FibreChannelPort struct {
    ...
    // PCI bus location of the HBA (Host Bus Adapter) for this Fibre Channel port.
    
 	BusLocation *string `json:"bus_location,omitempty"`
   
    // HBA (Host Bus Adapter) port number for this Fibre Channel port.
    
   	Port *int64 `json:"port,omitempty"`
   
    // HBA (Host Bus Adapter) slot number for this Fibre Channel port.
    ...
    // Information about the Fibre Channel link associated with this port.
