...
func EncodeProtectionTemplate(request interface{}) (*protectionTemplate, error) {
	...
	respProtectionTemplatePtr := &protectionTemplate{}
	err = json.Unmarshal(byte, respProtectionTemplatePtr)
	return respProtectionTemplatePtr, err
}
...
func DecodeProtectionTemplate(request interface{}) (*ProtectionTemplate, error) {
	...
	respProtectionTemplate := &ProtectionTemplate{}
	err = json.Unmarshal(byte, respProtectionTemplate)
	return respProtectionTemplate, err
}
