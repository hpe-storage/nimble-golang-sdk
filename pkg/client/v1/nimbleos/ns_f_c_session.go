...
func EncodeNsFCSession(request interface{}) (*nsFCSession, error) {
	...
	respNsFCSessionPtr := &nsFCSession{}
	err = json.Unmarshal(byte, respNsFCSessionPtr)
	return respNsFCSessionPtr, err
}
...
func DecodeNsFCSession(request interface{}) (*NsFCSession, error) {
	...
	respNsFCSession := &NsFCSession{}
	err = json.Unmarshal(byte, respNsFCSession)
	return respNsFCSession, err
}
