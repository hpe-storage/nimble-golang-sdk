...
func EncodeCertificate(request interface{}) (*certificate, error) {
	...
	respCertificatePtr := &certificate{}
	err = json.Unmarshal(byte, respCertificatePtr)
	return respCertificatePtr, err
}
...
func DecodeCertificate(request interface{}) (*Certificate, error) {
	...
	respCertificate := &Certificate{}
	err = json.Unmarshal(byte, respCertificate)
	return respCertificate, err
}
