...
func EncodeNsDiskSetAttr(request interface{}) (*nsDiskSetAttr, error) {
	...
	respNsDiskSetAttrPtr := &nsDiskSetAttr{}
	err = json.Unmarshal(byte, respNsDiskSetAttrPtr)
	return respNsDiskSetAttrPtr, err
}
...
func DecodeNsDiskSetAttr(request interface{}) (*NsDiskSetAttr, error) {
	...
	respNsDiskSetAttr := &NsDiskSetAttr{}
	err = json.Unmarshal(byte, respNsDiskSetAttr)
	return respNsDiskSetAttr, err
}
