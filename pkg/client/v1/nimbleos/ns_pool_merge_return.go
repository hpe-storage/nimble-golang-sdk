...
// EncodeNsPoolMergeReturn - Transform NsPoolMergeReturn to nsPoolMergeReturn type
func EncodeNsPoolMergeReturn(request interface{}) (*nsPoolMergeReturn, error) {
	reqNsPoolMergeReturn := request.(*NsPoolMergeReturn)
	byte, err := json.Marshal(reqNsPoolMergeReturn)
	if err != nil {
		return nil, err
	}
	respNsPoolMergeReturnPtr := &nsPoolMergeReturn{}
	err = json.Unmarshal(byte, respNsPoolMergeReturnPtr)
	return respNsPoolMergeReturnPtr, err
}

// DecodeNsPoolMergeReturn Transform nsPoolMergeReturn to NsPoolMergeReturn type
func DecodeNsPoolMergeReturn(request interface{}) (*NsPoolMergeReturn, error) {
	reqNsPoolMergeReturn := request.(*nsPoolMergeReturn)
	byte, err := json.Marshal(reqNsPoolMergeReturn)
	if err != nil {
		return nil, err
	}
	respNsPoolMergeReturn := &NsPoolMergeReturn{}
	err = json.Unmarshal(byte, respNsPoolMergeReturn)
	return respNsPoolMergeReturn, err
}
