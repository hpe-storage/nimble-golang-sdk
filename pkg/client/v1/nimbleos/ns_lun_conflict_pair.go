...
func EncodeNsLunConflictPair(request interface{}) (*nsLunConflictPair, error) {
	...
	respNsLunConflictPairPtr := &nsLunConflictPair{}
	err = json.Unmarshal(byte, respNsLunConflictPairPtr)
	return respNsLunConflictPairPtr, err
}
...
func DecodeNsLunConflictPair(request interface{}) (*NsLunConflictPair, error) {
	...
	respNsLunConflictPair := &NsLunConflictPair{}
	err = json.Unmarshal(byte, respNsLunConflictPair)
	return respNsLunConflictPair, err
}
