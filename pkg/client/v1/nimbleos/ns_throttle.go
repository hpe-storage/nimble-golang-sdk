...
func EncodeNsThrottle(request interface{}) (*nsThrottle, error) {
	...
	respNsThrottlePtr := &nsThrottle{}
	err = json.Unmarshal(byte, respNsThrottlePtr)
	return respNsThrottlePtr, err
}
...
func DecodeNsThrottle(request interface{}) (*NsThrottle, error) {
	...
	respNsThrottle := &NsThrottle{}
	err = json.Unmarshal(byte, respNsThrottle)
	return respNsThrottle, err
}
