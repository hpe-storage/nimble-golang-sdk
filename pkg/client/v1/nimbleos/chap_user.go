...
func EncodeChapUser(request interface{}) (*chapUser, error) {
	...
	respChapUserPtr := &chapUser{}
	err = json.Unmarshal(byte, respChapUserPtr)
	return respChapUserPtr, err
}
...
func DecodeChapUser(request interface{}) (*ChapUser, error) {
	...
	respChapUser := &ChapUser{}
	err = json.Unmarshal(byte, respChapUser)
	return respChapUser, err
}
