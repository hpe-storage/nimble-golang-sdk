...
// EncodeAccessControlRecord - Transform AccessControlRecord to accessControlRecord type
func EncodeAccessControlRecord(request interface{}) (*accessControlRecord, error) {
	reqAccessControlRecord := request.(*AccessControlRecord)
	byte, err := json.Marshal(reqAccessControlRecord)
	if err != nil {
		return nil, err
	}
	respAccessControlRecordPtr := &accessControlRecord{}
	err = json.Unmarshal(byte, respAccessControlRecordPtr)
	return respAccessControlRecordPtr, err
}

// DecodeAccessControlRecord Transform accessControlRecord to AccessControlRecord type
func DecodeAccessControlRecord(request interface{}) (*AccessControlRecord, error) {
	reqAccessControlRecord := request.(*accessControlRecord)
	byte, err := json.Marshal(reqAccessControlRecord)
	if err != nil {
		return nil, err
	}
	respAccessControlRecord := &AccessControlRecord{}
	err = json.Unmarshal(byte, respAccessControlRecord)
	return respAccessControlRecord, err
}
