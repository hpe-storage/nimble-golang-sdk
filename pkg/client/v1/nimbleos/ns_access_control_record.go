...
func EncodeNsAccessControlRecord(request interface{}) (*nsAccessControlRecord, error) {
	...
	respNsAccessControlRecordPtr := &nsAccessControlRecord{}
	err = json.Unmarshal(byte, respNsAccessControlRecordPtr)
	return respNsAccessControlRecordPtr, err
}
...
func DecodeNsAccessControlRecord(request interface{}) (*NsAccessControlRecord, error) {
	...
	respNsAccessControlRecord := &NsAccessControlRecord{}
	err = json.Unmarshal(byte, respNsAccessControlRecord)
	return respNsAccessControlRecord, err
}
