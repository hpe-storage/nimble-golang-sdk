...
func EncodeApplicationServer(request interface{}) (*applicationServer, error) {
	...
	respApplicationServerPtr := &applicationServer{}
	err = json.Unmarshal(byte, respApplicationServerPtr)
	return respApplicationServerPtr, err
}
...
func DecodeApplicationServer(request interface{}) (*ApplicationServer, error) {
	...
	respApplicationServer := &ApplicationServer{}
	err = json.Unmarshal(byte, respApplicationServer)
	return respApplicationServer, err
}
