...
func EncodeFibreChannelInterface(request interface{}) (*fibreChannelInterface, error) {
	...
	respFibreChannelInterfacePtr := &fibreChannelInterface{}
	err = json.Unmarshal(byte, respFibreChannelInterfacePtr)
	return respFibreChannelInterfacePtr, err
}
...
func DecodeFibreChannelInterface(request interface{}) (*FibreChannelInterface, error) {
	...
	respFibreChannelInterface := &FibreChannelInterface{}
	err = json.Unmarshal(byte, respFibreChannelInterface)
	return respFibreChannelInterface, err
}
