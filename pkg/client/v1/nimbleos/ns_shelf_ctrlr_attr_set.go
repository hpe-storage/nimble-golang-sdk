...
func EncodeNsShelfCtrlrAttrSet(request interface{}) (*nsShelfCtrlrAttrSet, error) {
	...
	respNsShelfCtrlrAttrSetPtr := &nsShelfCtrlrAttrSet{}
	err = json.Unmarshal(byte, respNsShelfCtrlrAttrSetPtr)
	return respNsShelfCtrlrAttrSetPtr, err
}
...
func DecodeNsShelfCtrlrAttrSet(request interface{}) (*NsShelfCtrlrAttrSet, error) {
	...
	respNsShelfCtrlrAttrSet := &NsShelfCtrlrAttrSet{}
	err = json.Unmarshal(byte, respNsShelfCtrlrAttrSet)
	return respNsShelfCtrlrAttrSet, err
}
