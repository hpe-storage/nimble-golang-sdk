...
func EncodeInitiator(request interface{}) (*initiator, error) {
	...
	respInitiatorPtr := &initiator{}
	err = json.Unmarshal(byte, respInitiatorPtr)
	return respInitiatorPtr, err
}
...
func DecodeInitiator(request interface{}) (*Initiator, error) {
	...
	respInitiator := &Initiator{}
	err = json.Unmarshal(byte, respInitiator)
	return respInitiator, err
}
