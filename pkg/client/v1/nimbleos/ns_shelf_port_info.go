...
func EncodeNsShelfPortInfo(request interface{}) (*nsShelfPortInfo, error) {
	...
	respNsShelfPortInfoPtr := &nsShelfPortInfo{}
	err = json.Unmarshal(byte, respNsShelfPortInfoPtr)
	return respNsShelfPortInfoPtr, err
}
...
func DecodeNsShelfPortInfo(request interface{}) (*NsShelfPortInfo, error) {
	...
	respNsShelfPortInfo := &NsShelfPortInfo{}
	err = json.Unmarshal(byte, respNsShelfPortInfo)
	return respNsShelfPortInfo, err
}
