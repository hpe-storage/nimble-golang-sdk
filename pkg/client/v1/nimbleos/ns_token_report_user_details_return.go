...
func EncodeNsTokenReportUserDetailsReturn(request interface{}) (*nsTokenReportUserDetailsReturn, error) {
	...
	respNsTokenReportUserDetailsReturnPtr := &nsTokenReportUserDetailsReturn{}
	err = json.Unmarshal(byte, respNsTokenReportUserDetailsReturnPtr)
	return respNsTokenReportUserDetailsReturnPtr, err
}
...
func DecodeNsTokenReportUserDetailsReturn(request interface{}) (*NsTokenReportUserDetailsReturn, error) {
	...
	respNsTokenReportUserDetailsReturn := &NsTokenReportUserDetailsReturn{}
	err = json.Unmarshal(byte, respNsTokenReportUserDetailsReturn)
	return respNsTokenReportUserDetailsReturn, err
}
