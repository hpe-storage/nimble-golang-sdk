...
func EncodeObjectLimit(request interface{}) (*objectLimit, error) {
	...
	respObjectLimitPtr := &objectLimit{}
	err = json.Unmarshal(byte, respObjectLimitPtr)
	return respObjectLimitPtr, err
}
...
func DecodeObjectLimit(request interface{}) (*ObjectLimit, error) {
	...
	respObjectLimit := &ObjectLimit{}
	err = json.Unmarshal(byte, respObjectLimit)
	return respObjectLimit, err
}
