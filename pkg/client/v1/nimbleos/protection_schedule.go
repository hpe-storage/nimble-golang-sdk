...
func EncodeProtectionSchedule(request interface{}) (*protectionSchedule, error) {
	...
	respProtectionSchedulePtr := &protectionSchedule{}
	err = json.Unmarshal(byte, respProtectionSchedulePtr)
	return respProtectionSchedulePtr, err
}
...
func DecodeProtectionSchedule(request interface{}) (*ProtectionSchedule, error) {
	...
	respProtectionSchedule := &ProtectionSchedule{}
	err = json.Unmarshal(byte, respProtectionSchedule)
	return respProtectionSchedule, err
}
