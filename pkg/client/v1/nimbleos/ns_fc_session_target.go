...
func EncodeNsFcSessionTarget(request interface{}) (*nsFcSessionTarget, error) {
	...
	respNsFcSessionTargetPtr := &nsFcSessionTarget{}
	err = json.Unmarshal(byte, respNsFcSessionTargetPtr)
	return respNsFcSessionTargetPtr, err
}
...
func DecodeNsFcSessionTarget(request interface{}) (*NsFcSessionTarget, error) {
	...
	respNsFcSessionTarget := &NsFcSessionTarget{}
	err = json.Unmarshal(byte, respNsFcSessionTarget)
	return respNsFcSessionTarget, err
}
