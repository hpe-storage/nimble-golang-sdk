...
func EncodeNetworkConfig(request interface{}) (*networkConfig, error) {
	...
	respNetworkConfigPtr := &networkConfig{}
	err = json.Unmarshal(byte, respNetworkConfigPtr)
	return respNetworkConfigPtr, err
}
...
func DecodeNetworkConfig(request interface{}) (*NetworkConfig, error) {
	...
	err = json.Unmarshal(byte, respNetworkConfig)
	return respNetworkConfig, err
}
